...
impl ParquetDataCatalog {
    ...
    /// Sets a cooperative cancellation flag for catalog query streams.
    pub fn set_query_cancellation(&mut self, cancellation: Option<Arc<AtomicBool>>) {
        self.query_cancellation.clone_from(&cancellation);
    ...
    /// # Errors
    ///
    /// Returns an error for duplicate paths, invalid paths, read failures, or decode failures.
