...
pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(111, 1, 0, 0, 244, 1, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 72] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(246, 1, 0, 0, 242, 2, 0, 0),
...
impl ::core::convert::TryFrom<u16> for OrderListType {
    type Error = ::capnp::NotInSchema;
    fn try_from(value: u16) -> ::core::result::Result<Self, <OrderListType as ::core::convert::TryFrom<u16>>::Error> {
        match value {
            0 => ::core::result::Result::Ok(Self::Standard),
            1 => ::core::result::Result::Ok(Self::Oco),
            2 => ::core::result::Result::Ok(Self::Opoco),
            3 => ::core::result::Result::Ok(Self::ProtectedEntry),
            n => ::core::result::Result::Err(::capnp::NotInSchema(n)),
        }
    }
}
impl From<OrderListType> for u16 {
    #[inline]
    fn from(x: OrderListType) -> u16 { x as u16 }
}
impl ::capnp::traits::HasTypeId for OrderListType {
    const TYPE_ID: u64 = 0xaac1_595a_207c_e274u64;
}
mod order_list_type {
pub(crate) static ENCODED_NODE: [::capnp::Word; 38] = [
    ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
    ::capnp::word(116, 226, 124, 32, 90, 89, 193, 170),
    ::capnp::word(19, 0, 0, 0, 2, 0, 0, 0),
    ::capnp::word(41, 24, 7, 246, 229, 212, 195, 178),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(201, 7, 0, 0, 33, 8, 0, 0),
    ::capnp::word(21, 0, 0, 0, 10, 1, 0, 0),
    ::capnp::word(37, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(33, 0, 0, 0, 103, 0, 0, 0),
    ...
    ::capnp::word(110, 117, 109, 115, 46, 99, 97, 112),
    ::capnp::word(110, 112, 58, 79, 114, 100, 101, 114),
    ::capnp::word(76, 105, 115, 116, 84, 121, 112, 101),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
    ::capnp::word(16, 0, 0, 0, 1, 0, 2, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(111, 99, 111, 0, 0, 0, 0, 0),
    ::capnp::word(111, 112, 111, 99, 111, 0, 0, 0),
    ::capnp::word(112, 114, 111, 116, 101, 99, 116, 101),
    ::capnp::word(100, 69, 110, 116, 114, 121, 0, 0),
];
pub(crate) fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ::capnp::introspect::panic_invalid_annotation_indices(child_index, index)
}
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 33] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(121, 8, 0, 0, 195, 8, 0, 0),
    ::capnp::word(21, 0, 0, 0, 10, 1, 0, 0),
    ::capnp::word(37, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(33, 0, 0, 0, 79, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 36] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(208, 9, 0, 0, 35, 10, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 46] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(37, 10, 0, 0, 157, 11, 0, 0),
    ::capnp::word(21, 0, 0, 0, 242, 0, 0, 0),
    ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 30] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(159, 11, 0, 0, 219, 11, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 39] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(221, 11, 0, 0, 45, 12, 0, 0),
    ::capnp::word(21, 0, 0, 0, 234, 0, 0, 0),
    ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 99] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(47, 12, 0, 0, 116, 13, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 44] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(118, 13, 0, 0, 236, 13, 0, 0),
    ::capnp::word(21, 0, 0, 0, 50, 1, 0, 0),
    ::capnp::word(37, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 32] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(238, 13, 0, 0, 50, 14, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 32] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(52, 14, 0, 0, 125, 14, 0, 0),
    ::capnp::word(21, 0, 0, 0, 2, 1, 0, 0),
    ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(29, 0, 0, 0, 79, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 30] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(127, 14, 0, 0, 200, 14, 0, 0),
...
impl ::core::convert::TryFrom<u16> for OptionalBool {
    type Error = ::capnp::NotInSchema;
    fn try_from(value: u16) -> ::core::result::Result<Self, <OptionalBool as ::core::convert::TryFrom<u16>>::Error> {
        match value {
            0 => ::core::result::Result::Ok(Self::Unknown),
            1 => ::core::result::Result::Ok(Self::True),
            2 => ::core::result::Result::Ok(Self::False),
            n => ::core::result::Result::Err(::capnp::NotInSchema(n)),
        }
    }
}
impl From<OptionalBool> for u16 {
    #[inline]
    fn from(x: OptionalBool) -> u16 { x as u16 }
}
impl ::capnp::traits::HasTypeId for OptionalBool {
    const TYPE_ID: u64 = 0x96ce_58ac_51f3_a1b5u64;
}
mod optional_bool {
pub(crate) static ENCODED_NODE: [::capnp::Word; 31] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(202, 14, 0, 0, 10, 15, 0, 0),
    ::capnp::word(21, 0, 0, 0, 2, 1, 0, 0),
    ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(29, 0, 0, 0, 79, 0, 0, 0),
    ...
    ::capnp::word(110, 117, 109, 115, 46, 99, 97, 112),
    ::capnp::word(110, 112, 58, 79, 112, 116, 105, 111),
    ::capnp::word(110, 97, 108, 66, 111, 111, 108, 0),
    ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
    ::capnp::word(12, 0, 0, 0, 1, 0, 2, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 95] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(12, 15, 0, 0, 83, 16, 0, 0),
    ::capnp::word(21, 0, 0, 0, 50, 1, 0, 0),
    ::capnp::word(37, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
impl ::core::convert::TryFrom<u16> for PositionAdjustmentType {
    ...
    fn try_from(value: u16) -> ::core::result::Result<Self, <PositionAdjustmentType as ::core::convert::TryFrom<u16>>::Error> {
        match value {
            ...
            2 => ::core::result::Result::Ok(Self::Dust),
            n => ::core::result::Result::Err(::capnp::NotInSchema(n)),
        }
    }
}
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 34] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(85, 16, 0, 0, 164, 16, 0, 0),
    ...
    ::capnp::word(100, 117, 115, 116, 0, 0, 0, 0),
];
pub(crate) fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ::capnp::introspect::panic_invalid_annotation_indices(child_index, index)
}
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 86] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(166, 16, 0, 0, 178, 17, 0, 0),
    ::capnp::word(21, 0, 0, 0, 18, 1, 0, 0),
    ::capnp::word(37, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 32] = [
    ...
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(180, 17, 0, 0, 248, 17, 0, 0),
    ::capnp::word(21, 0, 0, 0, 2, 1, 0, 0),
    ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(29, 0, 0, 0, 79, 0, 0, 0),
