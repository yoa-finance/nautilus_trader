pub use decoder::MyFiltersResponseDecoder;
pub use encoder::MyFiltersResponseEncoder;
...
pub mod encoder {
    ...
    pub struct MyFiltersResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MyFiltersResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MyFiltersResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> MyFiltersResponseEncoder<'a> {
        ...
        #[inline]
        pub fn symbol_filters_encoder(
            self,
            count: u32,
            symbol_filters_encoder: SymbolFiltersEncoder<Self>,
        ) -> SymbolFiltersEncoder<Self> {
            symbol_filters_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=102)
        #[inline]
        pub fn asset_filters_encoder(
            self,
            count: u32,
            asset_filters_encoder: AssetFiltersEncoder<Self>,
        ) -> AssetFiltersEncoder<Self> {
            asset_filters_encoder.wrap(self, count)
        }
    }
    ...
    #[derive(Debug, Default)]
    pub struct SymbolFiltersEncoder<P> {
        parent: Option<P>,
        count: u32,
        index: usize,
        offset: usize,
    ...
    impl<'a, P> Writer<'a> for SymbolFiltersEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for SymbolFiltersEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> SymbolFiltersEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    #[derive(Debug, Default)]
    pub struct AssetFiltersEncoder<P> {
        parent: Option<P>,
        count: u32,
        index: usize,
        offset: usize,
    ...
    impl<'a, P> Writer<'a> for AssetFiltersEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for AssetFiltersEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> AssetFiltersEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
...
pub mod decoder {
    ...
    pub struct MyFiltersResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MyFiltersResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MyFiltersResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MyFiltersResponseDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MyFiltersResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn symbol_filters_decoder(self) -> SymbolFiltersDecoder<Self> {
            SymbolFiltersDecoder::default().wrap(self)
        }

        /// GROUP DECODER (id=102)
        #[inline]
        pub fn asset_filters_decoder(self) -> AssetFiltersDecoder<Self> {
            AssetFiltersDecoder::default().wrap(self)
        }
    }
    ...
    #[derive(Debug, Default)]
    pub struct SymbolFiltersDecoder<P> {
        parent: Option<P>,
        block_length: u16,
        count: u32,
        index: usize,
    ...
    impl<'a, P> ActingVersion for SymbolFiltersDecoder<P>
    where
        P: Reader<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for SymbolFiltersDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for SymbolFiltersDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> SymbolFiltersDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        pub fn wrap(mut self, mut parent: P) -> Self {
    ...
    #[derive(Debug, Default)]
    pub struct AssetFiltersDecoder<P> {
        parent: Option<P>,
        block_length: u16,
        count: u32,
        index: usize,
    ...
    impl<'a, P> ActingVersion for AssetFiltersDecoder<P>
    where
        P: Reader<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> Reader<'a> for AssetFiltersDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for AssetFiltersDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        #[inline]
    ...
    impl<'a, P> AssetFiltersDecoder<P>
    where
        P: Decoder<'a> + ActingVersion + Default,
    {
        pub fn wrap(mut self, mut parent: P) -> Self {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='assetFilters', referencedName='null', description='null', packageName='null', id=102, version=0, deprecated=0, encodedLength=0, offset=-1, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
